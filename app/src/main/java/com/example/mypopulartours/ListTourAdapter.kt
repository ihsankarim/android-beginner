...
class ListTourAdapter(private val listTour: ArrayList<Tour>, private val onItemClick: (Tour) -> Unit): RecyclerView.Adapter<ListTourAdapter.ListViewHolder>() {
